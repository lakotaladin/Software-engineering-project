...
function Booknow() {
    ...
    const getBus = async () => {
        try {
            ...
            const response = await axiosInstance.post("/api/bus/get-bus-by-id", {
                _id: params.id,
            });
            ...
            {bus && (<Row className='mt-3' gutter={[30,30]}>
                ...
                <Col lg={12} xs={24} sm={24}>
                    ...
                    <div className='flex flex-col gap-1'>
                        ...
                        <h1 className='text-lg'><b>Cena:</b> : &euro {bus.price}</h1>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        {/* Izlistana sedista */}
                        <h1 className='text-2xl mt-2'>Cena: {bus.fare * selectedSeats.length}</h1>
                    </div>
                    <hr />
